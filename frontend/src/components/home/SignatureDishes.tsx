...
const signatureDishes = [
  {
    ...
    price: '₹ 520',
    imageUrl: '/assets/generated/chettinad-chicken-curry.dim_400x400.png',
  ...
  },
  {
    ...
    price: '₹ 360',
    imageUrl: '/assets/generated/biryani.dim_400x400.png',
    badge: '⭐ Most Loved',
  ...
  },
  {
    ...
    price: '₹ 360',
    imageUrl: '/assets/generated/mutton-kola-urundai.dim_400x400.png',
    badge: '🏆 Best Seller',
    category: 'Coal Specials',
  },
  {
    id: 'sig4',
    name: 'Jigarthanda',
    description: 'Madurai\'s iconic chilled drink with sarsaparilla syrup, almond gum, and ice cream.',
    price: '₹ 120',
    imageUrl: '/assets/generated/jigarthanda.dim_400x400.png',
    badge: '🌿 Must Try',
    category: 'Beverages',
  },
];
