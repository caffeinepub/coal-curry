...
export const menuData: Dish[] = [
  ...
  { id: 'vs2', name: 'Paneer Tikka (Coal Grilled)', category: 'Veg Starters', description: 'Marinated cottage cheese cubes grilled over live coal fire for a smoky, charred finish.', spiceLevel: 2, priceDisplay: '₹ 260', imageUrl: IMAGES.dosa, isVeg: true, isSpecial: true },
  ...
  { id: 'vs5', name: 'Chilli Paneer', category: 'Veg Starters', description: 'Indo-Chinese style paneer tossed with bell peppers, onions, and fiery chilli sauce.', spiceLevel: 4, priceDisplay: '₹ 240', imageUrl: IMAGES.dosa, isVeg: true },
  ...
  { id: 'vs10', name: 'Mini Idli Sambar', category: 'Veg Starters', description: 'Bite-sized soft idlis dunked in aromatic sambar with ghee and curry leaves.', spiceLevel: 1, priceDisplay: '₹ 160', imageUrl: IMAGES.dosa, isVeg: true },
  ...
  { id: 'nvs2', name: 'Chettinad Chicken Fry', category: 'Non-Veg Starters', description: 'Bone-in chicken marinated in authentic Chettinad masala and pan-fried to perfection.', spiceLevel: 5, priceDisplay: '₹ 320', imageUrl: IMAGES.chicken, isVeg: false },
  { id: 'nvs3', name: 'Mutton Sukka', category: 'Non-Veg Starters', description: 'Tender mutton pieces dry-roasted with freshly ground spices and coconut in a traditional kadai.', spiceLevel: 4, priceDisplay: '₹ 380', imageUrl: IMAGES.chicken, isVeg: false },
  ...
  { id: 'nvs7', name: 'Fish Fry (Vanjaram)', category: 'Non-Veg Starters', description: 'King mackerel marinated in turmeric and red chilli paste, shallow fried on a tawa.', spiceLevel: 3, priceDisplay: '₹ 360', imageUrl: IMAGES.chicken, isVeg: false },
  { id: 'nvs8', name: 'Prawn Pepper Fry', category: 'Non-Veg Starters', description: 'Juicy prawns sautéed with black pepper, garlic, and curry leaves in a hot iron pan.', spiceLevel: 4, priceDisplay: '₹ 400', imageUrl: IMAGES.chicken, isVeg: false },
  ...
  // Coal Specials
  { id: 'cs1', name: 'Coal Grilled Paneer Steak', category: 'Coal Specials', description: 'Thick-cut paneer steak marinated in herb butter and grilled directly over glowing coal embers.', spiceLevel: 2, priceDisplay: '₹ 380', imageUrl: IMAGES.dosa, isVeg: true, isSpecial: true },
  ...
  { id: 'cs3', name: 'Coal Grilled Fish', category: 'Coal Specials', description: 'Fresh catch of the day marinated in Chettinad spices and grilled whole over live coal.', spiceLevel: 3, priceDisplay: '₹ 480', imageUrl: IMAGES.chicken, isVeg: false, isSpecial: true },
  { id: 'cs4', name: 'Smoky Mutton Chops', category: 'Coal Specials', description: 'Tender lamb chops marinated overnight and grilled over coal for a rich, smoky crust.', spiceLevel: 4, priceDisplay: '₹ 580', imageUrl: IMAGES.chicken, isVeg: false, isSpecial: true },
  ...
  { id: 'cs6', name: 'Coal Dum Biryani', category: 'Coal Specials', description: 'Aromatic biryani slow-cooked in a sealed clay pot over coal fire for authentic dum cooking.', spiceLevel: 3, priceDisplay: '₹ 480', imageUrl: IMAGES.biryani, isVeg: false, isSpecial: true },
  ...
  { id: 'cs9', name: 'Smoked Crab Masala', category: 'Coal Specials', description: 'Fresh crab cooked in a rich Chettinad masala with a hint of coal smoke for depth.', spiceLevel: 5, priceDisplay: '₹ 680', imageUrl: IMAGES.chicken, isVeg: false, isSpecial: true },
  ...
  // Biryani & Rice
  { id: 'br1', name: 'Chicken Biryani', category: 'Biryani & Rice', description: 'Fragrant basmati rice layered with spiced chicken and slow-cooked in dum style.', spiceLevel: 3, priceDisplay: '₹ 320', imageUrl: IMAGES.biryani, isVeg: false },
  { id: 'br2', name: 'Mutton Biryani', category: 'Biryani & Rice', description: 'Tender mutton pieces cooked with aromatic spices and long-grain basmati in traditional dum.', spiceLevel: 4, priceDisplay: '₹ 420', imageUrl: IMAGES.biryani, isVeg: false },
  { id: 'br3', name: 'Prawn Biryani', category: 'Biryani & Rice', description: 'Juicy prawns layered with saffron-infused rice and coastal spices for a seafood delight.', spiceLevel: 3, priceDisplay: '₹ 380', imageUrl: IMAGES.biryani, isVeg: false },
  { id: 'br4', name: 'Veg Biryani', category: 'Biryani & Rice', description: 'Seasonal vegetables and paneer cooked with fragrant basmati and whole spices.', spiceLevel: 2, priceDisplay: '₹ 260', imageUrl: IMAGES.biryani, isVeg: true },
  { id: 'br5', name: 'Egg Biryani', category: 'Biryani & Rice', description: 'Boiled eggs cooked in a spiced masala and layered with aromatic basmati rice.', spiceLevel: 3, priceDisplay: '₹ 280', imageUrl: IMAGES.biryani, isVeg: false },
  { id: 'br6', name: 'Seeraga Samba Biryani', category: 'Biryani & Rice', description: 'Traditional Tamil biryani made with rare seeraga samba rice and authentic Chettinad spices.', spiceLevel: 4, priceDisplay: '₹ 360', imageUrl: IMAGES.biryani, isVeg: false, isSpecial: true },
  ...
  { id: 'br9', name: 'Curd Rice', category: 'Biryani & Rice', description: 'Cooling yogurt rice tempered with mustard, ginger, and pomegranate — the perfect meal ender.', spiceLevel: 1, priceDisplay: '₹ 160', imageUrl: IMAGES.biryani, isVeg: true },
  ...
  { id: 'dt7', name: 'Pongal', category: 'Dosa & Tiffin', description: 'Creamy rice and lentil porridge tempered with ghee, black pepper, and cashews.', spiceLevel: 1, priceDisplay: '₹ 140', imageUrl: IMAGES.dosa, isVeg: true },
  ...
  { id: 'dt10', name: 'Kothu Parotta', category: 'Dosa & Tiffin', description: 'Shredded layered parotta stir-fried with eggs, onions, and spiced masala on a hot griddle.', spiceLevel: 3, priceDisplay: '₹ 220', imageUrl: IMAGES.dosa, isVeg: false },

  // Seafood Specials
  { id: 'ss1', name: 'Meen Kuzhambu', category: 'Seafood Specials', description: 'Traditional Tamil fish curry cooked in tamarind gravy with freshly ground Chettinad spices.', spiceLevel: 4, priceDisplay: '₹ 380', imageUrl: IMAGES.chicken, isVeg: false },
  { id: 'ss2', name: 'Prawn Masala', category: 'Seafood Specials', description: 'Succulent prawns cooked in a rich onion-tomato masala with coastal spices.', spiceLevel: 3, priceDisplay: '₹ 420', imageUrl: IMAGES.chicken, isVeg: false },
  { id: 'ss3', name: 'Crab Curry', category: 'Seafood Specials', description: 'Fresh crab cooked in a fiery Chettinad coconut masala — a true coastal delicacy.', spiceLevel: 5, priceDisplay: '₹ 580', imageUrl: IMAGES.chicken, isVeg: false },
  { id: 'ss4', name: 'Fish 65', category: 'Seafood Specials', description: 'Crispy fried fish tossed in a spicy tangy sauce with curry leaves and green chillies.', spiceLevel: 4, priceDisplay: '₹ 320', imageUrl: IMAGES.chicken, isVeg: false },
  { id: 'ss5', name: 'Squid Fry', category: 'Seafood Specials', description: 'Tender squid rings marinated in pepper and spices, shallow fried to a perfect crisp.', spiceLevel: 3, priceDisplay: '₹ 360', imageUrl: IMAGES.chicken, isVeg: false },

  // Beverages
  { id: 'bv1', name: 'Jigarthanda', category: 'Beverages', description: 'Madurai\'s iconic cold drink with milk, almond gum, nannari syrup, and ice cream.', spiceLevel: 0, priceDisplay: '₹ 120', imageUrl: IMAGES.dosa, isVeg: true },
  ...
  // Desserts
  { id: 'ds1', name: 'Elaneer Payasam', category: 'Desserts', description: 'Creamy tender coconut pudding with milk, sugar, and cardamom — a Kerala-Tamil fusion.', spiceLevel: 0, priceDisplay: '₹ 160', imageUrl: IMAGES.dosa, isVeg: true },
  { id: 'ds2', name: 'Gulab Jamun', category: 'Desserts', description: 'Soft milk-solid dumplings soaked in rose-cardamom sugar syrup, served warm.', spiceLevel: 0, priceDisplay: '₹ 120', imageUrl: IMAGES.dosa, isVeg: true },
  { id: 'ds3', name: 'Brownie with Ice Cream', category: 'Desserts', description: 'Warm chocolate brownie served with a scoop of vanilla ice cream and chocolate drizzle.', spiceLevel: 0, priceDisplay: '₹ 200', imageUrl: IMAGES.dosa, isVeg: true },
  { id: 'ds4', name: 'Kesari', category: 'Desserts', description: 'Traditional semolina halwa with saffron, ghee, cashews, and raisins — a temple sweet.', spiceLevel: 0, priceDisplay: '₹ 100', imageUrl: IMAGES.dosa, isVeg: true },
  { id: 'ds5', name: 'Falooda', category: 'Desserts', description: 'Layered dessert drink with rose syrup, basil seeds, vermicelli, milk, and ice cream.', spiceLevel: 0, priceDisplay: '₹ 180', imageUrl: IMAGES.dosa, isVeg: true },
];
